...
img_folder = "generated_images_orig_blocked_r_cluster_1_embeddings_block_all_g3_0.428/"
img_name = "img_0000_00.jpg"
image = Image.open(img_folder+img_name).convert("RGB")
display(image)