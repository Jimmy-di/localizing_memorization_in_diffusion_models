...
python 4_generate_images.py --original_images -o=generated_images_orig_unblocked_r_$1_$2 --result_file results/memorization_statistics_r_$1_0_v1_4.csv --num_samples 5
python 4_generate_images.py --refined_neurons -o=generated_images_orig_blocked_r_$1_$2 --result_file results/memorization_statistics_r_$1_0_v1_4.csv --num_samples 5
...
python 4_generate_images.py --original_images -o=generated_images_orig_unblocked_r_$1_$3 --result_file results/memorization_statistics_r_$1_0_v1_4.csv --num_samples 5
python 4_generate_images.py --refined_neurons -o=generated_images_orig_blocked_r_$1_$3 --result_file results/memorization_statistics_r_$1_0_v1_4.csv --num_samples 5
